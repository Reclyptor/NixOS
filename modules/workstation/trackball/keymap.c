...
//
// Super on the inner TR, drag-scroll on the tall outer TRR. They stay adjacent
// because Super + scroll is a workspace-switch chord in hyprland.nix.
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT( MS_BTN3, DPI_CONFIG, KC_LGUI, DRAG_SCROLL, MS_BTN1, MS_BTN2 )
};
