_: {
  flake.modules.nixos.workstation = _: {
    ...
    # that category is its own dataset on the NAS, and NFS does not cross a dataset
    ...
    # holding up boot.
    fileSystems."/data/nfs/dxp4800/<category>" = {
      device = "192.168.1.3:/mnt/primary/videos/<category>";
      fsType = "nfs4";
      options = [
        "defaults"
        "_netdev"
