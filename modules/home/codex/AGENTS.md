...
code. For anything beyond a trivial edit, plan first and interview the user
about technical implementation, UX, concerns, and tradeoffs - ask pointed,
structured questions before writing code. Write detailed specs upfront in
`SPEC.md` to reduce ambiguity. The spec becomes the contract - execute
