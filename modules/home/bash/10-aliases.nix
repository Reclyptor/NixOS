_: {
  flake.modules.homeManager.base = _: {
    programs.bash.shellAliases = {
      ...
      # Double quotes, not single: the alias body is stored verbatim, so single
      # quotes would survive into the expansion and hand mongosh the literal
      # ${ATLAS_MONGODB_HOST}. The URI still needs quoting for its ? and &.
