...
anything beyond a trivial edit, enter plan mode and use the
...
to reduce ambiguity. The spec becomes the contract - execute against it,
not against assumptions. Strip away all assumptions before touching code.
