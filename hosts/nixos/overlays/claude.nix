  ...
  nixpkgs.overlays = [
    (final: prev: {
      claude-code = prev.buildNpmPackage (finalAttrs: {
        ...
        npmDepsHash = "sha256-5nSCq/8Z/rqx/Ucz2M3jvlJleT+pSXR2EqlU5jPQFsQ=";
          ...
          cp ${builtins.toFile "package-lock.json" (builtins.toJSON {
            ...
            packages = {
              ...
              "node_modules/@img/sharp-darwin-arm64" = {
                ...
                optionalDependencies."@img/sharp-libvips-darwin-arm64" = "1.2.4";
              };
              "node_modules/@img/sharp-darwin-x64" = {
                ...
                engines.node = "^18.17.0 || ^20.3.0 || >=21.0.0";
                funding.url = "https://opencollective.com/libvips";
                optionalDependencies."@img/sharp-libvips-darwin-x64" = "1.2.4";
              };
              ...
              "node_modules/@img/sharp-linux-arm" = {
                ...
                engines.node = "^18.17.0 || ^20.3.0 || >=21.0.0";
                funding.url = "https://opencollective.com/libvips";
                optionalDependencies."@img/sharp-libvips-linux-arm" = "1.2.4";
              };
              ...
              "node_modules/@img/sharp-linuxmusl-arm64" = {
                ...
                engines.node = "^18.17.0 || ^20.3.0 || >=21.0.0";
                funding.url = "https://opencollective.com/libvips";
                optionalDependencies."@img/sharp-libvips-linuxmusl-arm64" = "1.2.4";
              };
              "node_modules/@img/sharp-linuxmusl-x64" = {
                ...
                engines.node = "^18.17.0 || ^20.3.0 || >=21.0.0";
                funding.url = "https://opencollective.com/libvips";
                optionalDependencies."@img/sharp-libvips-linuxmusl-x64" = "1.2.4";
              };
